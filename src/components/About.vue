  ...
  <v-row id="main_content" style="padding: 50px">
    <v-col style="background-color: rgba(230,230,230,0.8); border-radius: 10px;">
      ...
      <p style="text-align:center;">
          <img src="/src/static/about/pmp_flow.png" style="max-width:100%" alt="Generalized model flowchart for Positive Mathematical Programming."><br>
      ...
      <p style="text-align:center;">
        <img src="/src/static/about/delta_ag_production.png" style="max-width:100%" alt="Sacramento-San Joaquin Delta Cropping Patterns utilized as inputs for OpenAg."><br>
      ...
      <p style="text-align:center">
        <video src="/src/static/about/WA_36s_Demo.mp4"
        controls
