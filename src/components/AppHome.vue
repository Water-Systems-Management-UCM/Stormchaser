...
<!--        </v-card>-->
      ...
      <v-col class="mx-auto" v-if="$store.getters.current_model_area.background_code === 'cali' || $store.getters.current_model_area.background_code === 'cdfa' || $store.getters.current_model_area.background_code === 'planning_area'">
