      ...
      <v-row id="model_info">
        <v-col class="col-12 col-md-4">
          <v-card tile>
            ...
            <p v-if="waterspout_data.is_base">
              Base-Case with no modifications
            </p>
            <p v-if="!waterspout_data.description && !waterspout_data.is_base">
              No Description
            </p>
            <v-col class="login col-10 offset-1 col-md-6 offset-md-2">
              <v-btn tile @click="edit_description = true">
                Edit
                <v-icon>mdi-brush</v-icon>
              </v-btn>
            </v-col>
        ...
        <v-col class="col-12 col-md-4">
          <v-card tile>
            ...
            <h3>Run Created</h3>
            <p>
              {{ new Date(waterspout_data.date_submitted).toLocaleString() }}
            </p>
          </v-card>
        </v-col>
      </v-row>
        ...
        <v-col class="col-12">
          <v-tabs>
            ...
            <v-tab-item v-if="has_results">
              ...
              <v-row class="stormchaser_resultsviz" v-if="!has_results">
            ...
            <v-tab-item>
              ...
              <p v-if="!has_region_modifications">
              ...
              <p v-if="!has_crop_modifications">
                No modifications to the model's crop settings in this run.
              </p>
            </v-tab-item>
            <v-tab-item v-if="has_infeasibilities">
              <h3>Infeasibilities</h3>
              <p v-if="waterspout_data.results.infeasibilities_text">
                Crops and how often they each appear in infeasible regions:
...
export default {
  ...
  methods: {
    ...
    download_csv_results() {
      this.$stormchaser_utils.download_array_as_csv({
        data: this.waterspout_data.results.result_set,
    ...
    download_csv_input_regions() {
      this.$stormchaser_utils.download_array_as_csv({
        data: this.waterspout_data.region_modifications,
    ...
    download_csv_input_crops() {
      this.$stormchaser_utils.download_array_as_csv({
        data: this.waterspout_data.crop_modifications,
