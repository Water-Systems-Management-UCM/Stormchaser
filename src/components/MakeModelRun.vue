  ...
  <v-stepper
    ...
    <!--   ALL REGION CARD             -->
            ...
            <v-row no-gutters>
              ...
              <v-col style="max-height: 570px;" class="align-end col-8 col-sm-2 col-md-5 col-lg-8">
...
export default defineComponent({
  ...
  data: function(){
      return {
        ...
        'default_crop': {...this.default_crop},
        'selected_crops': [],
        'selected_region': []
        },
    ...
    */
    process_price_yield_threshold: function(new_values){
      ...
      higher_crops.forEach(function(crop){
        ...
        if(change_crop !== undefined){ // if we found it in the inactive crops list, activate the card, otherwise leave it alone
          ...
          _this.activate_crop({crop_code: change_crop.crop_code, price: new_price, yield: new_yield, auto_created: true});
        }
      });
    },
    get_header: function() {
    ...
    get_model_run_creation_json(){
      ...
      let body = `{
                        ...
                        "additional_constraints": ${JSON.stringify(this.additional_constraints)}
                    }`;
